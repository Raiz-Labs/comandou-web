      ...
      <div class="page">
        ...
        @if (!comanda.isLoading() && comanda.hasValue() && comanda.value().aberta) {
          <aside class="fechamento-section">
            ...
            <!-- Divisão de conta -->
            <app-divisao-conta [total]="totalAtivo()" (divisoesChange)="onDivisoesChange($event)" />
...
export class ComandaDetalheCaixaComponent implements OnInit, OnDestroy {
  ...
  protected onDivisoesChange(divisoes: number): void {
    this.divisoes.set(divisoes);
